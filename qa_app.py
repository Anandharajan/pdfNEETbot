...
st.set_page_config(page_title="The Crest NEET bot",page_icon=':shark:')
...
def main():
    ...
    st.sidebar.image("img/The Crest Logo.jpg")
    ...
    <div style="display: flex; align-items: center; margin-left: 0;">
        <h1 style="display: inline-block;">The Crest NEET bot</h1>
